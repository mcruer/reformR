...
#' by `read_excel`, and creates a structured template that can be used to interpret a
...
#'
#' @param raw_template A data frame, typically generated by `read_excel`,
...
#' @examples
#' \dontrun{
#'   raw <- read_excel("path_to_template.xlsx")
